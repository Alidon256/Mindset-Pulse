...
fun CommentSheetContentSpace(
    ...
    val comments by viewModel.getCommentsForPost(spaceId, postId).collectAsState(emptyList())
                ...
                IconButton(
                    onClick = {
                        if (commentText.isNotBlank()) {
                            viewModel.addCommentSpace(spaceId, postId, commentText)
                            commentText = ""
                        }
                    },

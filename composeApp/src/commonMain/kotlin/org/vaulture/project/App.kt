...
import org.vaulture.project.screens.onboarding.LoginScreen
import org.vaulture.project.viewmodels.LoginViewModel
import org.vaulture.project.utils.OnboardingManager
import org.vaulture.project.screens.onboarding.BestDealsScreen
import org.vaulture.project.screens.onboarding.ConnectScreen
import org.vaulture.project.screens.onboarding.OnboardingScreenOne
import org.vaulture.project.screens.onboarding.OnboardingScreenTwo
import org.vaulture.project.screens.onboarding.SplashScreen
import org.vaulture.project.screens.onboarding.WelcomeScreen
import org.vaulture.project.screens.home.AnalyticsScreen
import org.vaulture.project.screens.home.CheckInScreen
import org.vaulture.project.screens.home.HomeScreen
import org.vaulture.project.screens.home.RhythmHomeScreen
import org.vaulture.project.screens.home.RhythmPlayerScreen
import org.vaulture.project.screens.home.WellnessTimerScreen
import org.vaulture.project.screens.profile.ProfileScreen
import org.vaulture.project.screens.space.AddStoryScreen
import org.vaulture.project.screens.space.CommentSheetContent
import org.vaulture.project.screens.space.CreateSpaceScreen
import org.vaulture.project.screens.space.SpaceFilter
import org.vaulture.project.screens.space.SpacesHomeScreen
import org.vaulture.project.screens.space.SpacesScreen
import org.vaulture.project.theme.AppTheme
import org.vaulture.project.ui.screens.SpaceDetailScreen
import org.vaulture.project.utils.rememberKmpAudioPlayer
import org.vaulture.project.viewmodels.AnalyticsViewModel
...
object Routes {
    ...
    @Serializable data object TRENDS : NavDestination { override val routePattern: String = "TRENDS" } // New for Mindset Pulse
    ...
    @Serializable data class CHAT_DETAIL(val chatId: String) : NavDestination { override val routePattern: String = "CHAT_DETAIL" }
    ...
    @Serializable data object RHYTHM_HOME: NavDestination { override val routePattern: String = "RHYTHM_HOME" }
    ...
    @Serializable data object SPACES_HOME: NavDestination { override val routePattern: String = "SPACE_HOME" }
...
fun AppNavigation(
    ...
    // --- PIVOT TO MINDSET PULSE BOTTOM NAV ---
        ...
        Scaffold(
            ...
            if (startDestination == null) {
                ...
                NavHost(
                    ...
                    // Apply the padding so NavHost content does not go under the bottom bar
                    ...
                    composable<Routes.BEST_DEALS> {
                        BestDealsScreen(onGetStarted = { navController.navigate(Routes.CONNECT) })
                    }
                    ...
                    composable<Routes.LOGIN> {
                        LaunchedEffect(authState, navController) {
                            if (authState == true) {
                                navController.navigate(Routes.HOME) { popUpTo(navController.graph.id) { inclusive = true } }
                            }
                        }
                        LoginScreen(
                            viewModel = loginViewModel,
                            onGoogleSignInRequest = {
                                // For web, onGoogleSignInRequest from main.web.kt is used.
                                // For android, you'd trigger the Android-specific flow here.
                    ...
                    composable<Routes.ANALYTICS> {
                        val analyticsViewModel : AnalyticsViewModel = remember { AnalyticsViewModel() }
                        AnalyticsScreen(
                            navController = navController,
                        ...
                        SpacesScreen(
                            ...
                            onCommentClick = { storyId ->
                                selectedStoryIdForComments =
                                    storyId // This triggers the ModalBottomSheet in App.kt
                            }
                        )
                    ...
                    composable<Routes.SPACE_DETAIL> { backStackEntry ->
                        val spaceId = backStackEntry.toRoute<Routes.SPACE_DETAIL>().spaceId
                        SpaceDetailScreen(spaceId = spaceId, onNavigateBack = { navController.popBackStack() }, viewModel = spaceViewModel)
                    }
                    composable<Routes.ADD_STORY> {
                        AddStoryScreen(
                            viewModel = spaceViewModel,

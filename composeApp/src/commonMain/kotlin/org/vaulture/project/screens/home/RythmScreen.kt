...
import org.vaulture.project.components.FilterChips
...
fun RhythmHomeContent(
    ...
    val categories = remember {
        listOf(
            RhythmCategory("Focus", listOf("productivity", "concentration", "work")),
            RhythmCategory("Sleep", listOf("calm", "sleep", "ambient")),
            RhythmCategory("Relax", listOf("chill", "peaceful", "meditation")),
            RhythmCategory("Energy", listOf("upbeat", "motivation", "workout"))
        )
    }
